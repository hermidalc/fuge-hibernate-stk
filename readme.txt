    ...
    list of examples:
        ...
        %> mvn -f fuge-hibernate-web/pom.xml -Ddeploy
        ...
        %> mvn -f fuge-hibernate-web/pom.xml andromdapp:undeploy -o

            undeploys the war from your app server

        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-core (or mvn -f fuge-hibernate-core/pom.xml)
        ...
        %> mvn -f fuge-hibernate-core/pom.xml andromdapp:schema -Dtasks=drop
        ...
        %> mvn -f fuge-hibernate-core/pom.xml andromdapp:schema -Dtasks=update
        ...
        %> mvn -f fuge-hibernate-core/pom.xml andromdapp:schema -Dtasks=validate
        ...
        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-mda:[andromda:start-server] (or mvn -f fuge-hibernate-mda/pom.xml andromda:start-server)
        ...
        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-mda:[andromda:stop-server] (or mvn -f fuge-hibernate-mda/pom.xml andromda:stop-server)

            stops the AndroMDA server

        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-mda (or mvn -f fuge-hibernate-mda/pom.xml)

            runs AndroMDA on your model and thereby generating files in
            the subdirectories of the existing modules

        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-mda -Dfilter=java,hibernate (or mvn -f fuge-hibernate-mda/pom.xml -Dfilter=java,hibernate)
        ...
        %> mvn -N andromdapp:build -Dmodules=fuge-hibernate-mda,fuge-hibernate-core,fuge-hibernate-web -Dfilter=java -Ddeploy
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Allyson Lister\.m2\repository\fuge-hibernate\

        (*nix)
        /home/Allyson Lister/.maven/repository/fuge-hibernate/
